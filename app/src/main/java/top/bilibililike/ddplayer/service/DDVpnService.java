package top.bilibililike.ddplayer.service;
...
public class DDVpnService extends VpnService {
   /* private static final String TAG = DDVpnService.class.getSimpleName();
    ...
    private void connect() {
        ...
        startConnection(new DDVpnService(
                this, mNextConnectionId.getAndIncrement(), server, port, secret,
                proxyHost, proxyPort, allow, packages));
    }

    private void startConnection(final DDVpnService connection) {
